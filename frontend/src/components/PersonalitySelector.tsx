export const PRESET_PERSONALITIES = [
  {
    ...
    description: 'Youth athletes, beginners, and recreational runners who need encouragement to stay consistent',
    color: '#f97316',
  ...
  },
  {
    ...
    description: 'Serious competitive athletes and college programs who want to understand the science',
    color: '#3b82f6',
  ...
  },
  {
    ...
    description: 'High school programs and athletes who respond to tough love and clear expectations',
    color: '#6b7280',
  ...
  },
  {
    ...
    description: 'Elite athletes and coaches who prioritize longevity over short-term results',
    color: '#8b5cf6',
  ...
  },
  {
    ...
    description: 'Youth programs and athletes dealing with performance pressure',
    color: '#10b981',
  ...
  },
  {
    ...
    description: 'Experienced coaches who know exactly what they want',
    color: '#00E5A0',
    prompt: '',
  },
];
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
        {PRESET_PERSONALITIES.map(p => (
          ...
          >
            ...
            <div className="text-xs mt-1.5" style={{ color: 'var(--color-text-tertiary)' }}>
              <span style={{ color: 'var(--color-text-tertiary)', fontStyle: 'normal' }}>Best for: </span>
