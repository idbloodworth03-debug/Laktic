...
/**
 * Wrap premium features with this component. If no active subscription
 * is detected, it shows an upgrade prompt instead of the children.
 */
    ...
    return (
      <Card className="text-center py-10">
        <div className="flex flex-col items-center gap-4">
          <div className="w-14 h-14 rounded-full bg-brand-900/40 border border-brand-700/30 flex items-center justify-center text-2xl">
            &#9733;
          </div>
