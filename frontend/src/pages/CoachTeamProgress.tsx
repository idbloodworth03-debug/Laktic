              ...
              <div className="flex flex-col gap-6">
                <Card title={athleteDetail.profile.name}>
                  <div className="text-sm text-[var(--muted)]">
                    ...
                    {athleteDetail.profile.weekly_volume_miles && <span> &middot; Target {athleteDetail.profile.weekly_volume_miles} mi/wk</span>}
                  </div>
                </Card>
                        ...
                        <div key={r.id} className="flex items-center justify-between p-3 bg-dark-700 rounded-lg border border-[var(--border)]">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-[var(--muted)]">{r.distance} &middot; {new Date(r.race_date + 'T00:00:00').toLocaleDateString()}</div>
                            </div>
                          </div>
