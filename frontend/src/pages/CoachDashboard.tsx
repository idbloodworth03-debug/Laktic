...
export function CoachDashboard() {
  ...
  // Trial banner calculation (14 days from account creation)
  const trialDaysLeft = profile?.created_at
    ? Math.ceil((new Date(profile.created_at).getTime() + 14 * 86400000 - Date.now()) / 86400000)
    : null;
        ...
        <div className="bg-amber-900/20 border-b border-amber-700/30 px-6 py-2.5 flex items-center justify-between">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-amber-300 font-medium">
              {trialDaysLeft === 1 ? 'Last day' : `${trialDaysLeft} days`} remaining in your free trial.
            </span>
