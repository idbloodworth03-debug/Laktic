      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card title="Your Training" className="mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Input label="Season start date" type="date" min={new Date().toISOString().split('T')[0]} value={trainSeasonStart} onChange={e => setTrainSeasonStart(e.target.value)} onKeyDown={e => e.preventDefault()} />
              <Input label="Season end date" type="date" min={new Date().toISOString().split('T')[0]} value={trainSeasonEnd} onChange={e => setTrainSeasonEnd(e.target.value)} onKeyDown={e => e.preventDefault()} />
            </div>
            <Button
