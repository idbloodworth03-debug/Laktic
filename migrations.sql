...
-- Adds all fields collected during onboarding that were previously
-- missing, causing Supabase to silently discard them on UPDATE.
-- ════════════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════════════
-- Migration 037 — Add bio column to athlete_profiles
-- ════════════════════════════════════════════════════════════════════
